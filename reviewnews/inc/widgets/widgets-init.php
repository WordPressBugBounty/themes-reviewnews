...
if (!function_exists('reviewnews_widgets')) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function reviewnews_widgets()
    {
        register_widget('ReviewNews_author_info');
        register_widget('ReviewNews_Posts_lists');
        register_widget('ReviewNews_Express_Posts_List');
        register_widget('ReviewNews_Express_Posts_Single_Column');
        register_widget('ReviewNews_Express_Posts_Double_Column');
        register_widget('ReviewNews_Featured_Post');
        register_widget('ReviewNews_Posts_Slider');
        register_widget('ReviewNews_Trending_Posts');
        register_widget('ReviewNews_Social_Contacts');


    }
endif;
add_action('widgets_init', 'reviewnews_widgets');