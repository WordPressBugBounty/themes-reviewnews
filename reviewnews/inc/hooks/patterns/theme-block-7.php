...
return array(
    ...
    <!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"#1f1f1f"},":hover":{"color":{"text":"#0047AB"}}}},"color":{"text":"#1f1f1f"}},"fontSize":"medium"} /-->
