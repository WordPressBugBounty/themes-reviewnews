...
return array(
	'title'      => __( 'Large Posts', 'reviewnews' ),
    ...
    <!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"#1f1f1f"},":hover":{"color":{"text":"#0047AB"}}}},"typography":{"fontSize":"27px"},"color":{"text":"#1f1f1f"}}} /-->
