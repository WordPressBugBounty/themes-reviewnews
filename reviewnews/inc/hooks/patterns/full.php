...
return array(
    ...
    <h2 class="wp-block-heading alignfull">' . esc_html__( 'Featured News', 'reviewnews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <h2 class="wp-block-heading">' . esc_html__( 'Express Grid', 'reviewnews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <h2 class="wp-block-heading">' . esc_html__( 'About Author', 'reviewnews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:group {"align":"full","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignfull"><!-- wp:heading {"align":"full"} -->
    <h2 class="wp-block-heading alignfull">' . esc_html__( 'Three Columns', 'reviewnews' ) . ' </h2>
    <!-- /wp:heading -->
    
    <!-- wp:blockspare/blockspare-latest-posts-list {"uniqueClass":"blockspare-b9cd4f9b-525d-4","postsToShow":9,"displayPostDate":false,"displayPostAuthor":false,"postTitleFontSize":14,"linkColor":"#505050","displayPostCategory":false,"columns":"list-col-3","align":"full","imageSize":"thumbnail","marginTop":20,"marginBottom":28,"backGroundColor":"#ffffff","contentPaddingTop":0,"contentPaddingBottom":0,"categoryBackgroundColor":"#003bb3","enableComment":false,"titleOnHoverColor":"#1f1f1f","animation":"AFTfadeInRight","ImageUnit":"75","gutterSpace":15} /--></div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-column" style="flex-basis:70%"><!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide"><!-- wp:heading -->
    <h2 class="wp-block-heading">' . esc_html__( 'Post Slider', 'reviewnews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group alignwide"><!-- wp:heading -->
    <h2 class="wp-block-heading">' . esc_html__( 'Post Grid', 'reviewnews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <h2 class="wp-block-heading alignwide">' . esc_html__( 'Post List', 'reviewnews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide"><!-- wp:heading {"align":"wide"} -->
    <h2 class="wp-block-heading alignwide">' . esc_html__( 'Connect to Us', 'reviewnews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide"><!-- wp:heading {"align":"wide"} -->
    <h2 class="wp-block-heading alignwide">' . esc_html__( 'Advertisement', 'reviewnews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:group {"align":"full","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignfull"><!-- wp:heading {"align":"full"} -->
    <h2 class="wp-block-heading alignfull">' . esc_html__( 'Post Carousel', 'reviewnews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-column" style="flex-basis:70%"><!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide"><!-- wp:heading -->
    <h2 class="wp-block-heading">' . esc_html__( 'Express Tile', 'reviewnews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide"><!-- wp:heading {"align":"wide"} -->
    <h2 class="wp-block-heading alignwide">' . esc_html__( 'Single Column', 'reviewnews' ) . ' </h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:group -->
    <div class="wp-block-group"><!-- wp:heading -->
    <h2 class="wp-block-heading">' . esc_html__( 'Categories', 'reviewnews' ) . '</h2>
    <!-- /wp:heading -->
