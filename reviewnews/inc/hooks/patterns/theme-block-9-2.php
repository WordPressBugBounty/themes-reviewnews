...
return array(
	'title'      => __( 'Single Column - 2', 'reviewnews' ),
    'categories' => array( 'reviewnews' ),
	'content'    => '<!-- wp:query {"queryId":20,"query":{"perPage":6,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"metadata":{"categories":["reviewnews"],"patternName":"reviewnews/theme-block-9","name":"Grid"}} -->
    ...
    <div class="wp-block-group"><!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"#1f1f1f"},":hover":{"color":{"text":"#0047AB"}}}},"color":{"text":"#1f1f1f"}},"fontSize":"medium"} /-->
    
    <!-- wp:group {"style":{"spacing":{"blockGap":"15px"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
    <div class="wp-block-group"><!-- wp:post-author-name {"style":{"elements":{"link":{"color":{"text":"#1f1f1f"}}},"color":{"text":"#1f1f1f"},"typography":{"fontSize":"12px"}}} /-->
    ...
    <!-- wp:post-featured-image {"isLink":true,"aspectRatio":"3/2","style":{"layout":{"selfStretch":"fixed","flexSize":"50%"}}} /--></div>
    <!-- /wp:group -->
