...
return array(
	'title'      => __( 'Large Posts - 2', 'reviewnews' ),
    'categories' => array( 'reviewnews' ),
	'content'    => '<!-- wp:query {"queryId":20,"query":{"perPage":6,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"metadata":{"categories":["reviewnews"],"patternName":"reviewnews/theme-block-8","name":"Grid"}} -->
    ...
    <h2 class="wp-block-heading alignwide">Post Full</h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"#1f1f1f"},":hover":{"color":{"text":"#0047AB"}}}},"typography":{"fontSize":"27px"},"color":{"text":"#1f1f1f"}}} /-->
