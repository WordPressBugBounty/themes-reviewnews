...
return array(
	'title'      => __( 'Post Grid with Dark Background', 'reviewnews' ),
    ...
    <!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"#fefefe"},":hover":{"color":{"text":"#007acc"}}}},"color":{"text":"#fefefe"}},"fontSize":"medium"} /-->
