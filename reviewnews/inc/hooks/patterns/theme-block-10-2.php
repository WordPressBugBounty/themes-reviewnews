...
return array(
	'title'      => __( 'Post List - 2', 'reviewnews' ),
    'categories' => array( 'reviewnews' ),
	'content'    => '<!-- wp:query {"queryId":20,"query":{"perPage":6,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"metadata":{"categories":["reviewnews"],"patternName":"reviewnews/theme-block-10","name":"Grid"}} -->
    ...
    <div class="wp-block-group"><!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"#1f1f1f"},":hover":{"color":{"text":"#0047AB"}}}},"color":{"text":"#1f1f1f"},"typography":{"fontSize":"16px"}}} /-->
