...
return array(
	'title'      => __( '3 Columns Post Grid', 'reviewnews' ),
    ...
    <!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|black"},":hover":{"color":{"text":"#0047AB"}}}},"typography":{"fontSize":"1em"}},"textColor":"black"} /-->
