...
return array(
	'title'      => __( 'Post Grid - 2', 'reviewnews' ),
    'categories' => array( 'reviewnews' ),
	'content'    => '<!-- wp:query {"queryId":20,"query":{"perPage":6,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"metadata":{"categories":["reviewnews"],"patternName":"reviewnews/theme-block-7","name":"Grid"}} -->
    ...
    <div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"#1f1f1f"},":hover":{"color":{"text":"#0047AB"}}}},"color":{"text":"#1f1f1f"}},"fontSize":"medium"} /-->
    ...
    <!-- wp:post-date {"style":{"typography":{"fontSize":"12px"},"elements":{"link":{"color":{"text":"#1f1f1f"}}},"color":{"text":"#1f1f1f"}}} /--></div>
    <!-- /wp:group -->
