<?php
if (!function_exists('reviewnews_by_author')) {
  function reviewnews_by_author($gravatar = '')
  {
    ...
    if (class_exists('WP_Post_Author')) {
      ...
      if (isset($awpa_post_authors) && !empty($awpa_post_authors) && $multiauthor_settings == true) {
        foreach ($awpa_post_authors as $key => $author_id) {
          ...
          reviewnews_author_list($post_id, $author_id, $author_type, $gravatar);
...
if (!function_exists('reviewnews_author_list')) {
  function reviewnews_author_list($post_id = '', $author_id = '', $author_type = '', $gravatar = false)
  {
