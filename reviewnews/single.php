        ...
        <main id="main" class="site-main">
            ...
            while (have_posts()) : the_post(); ?>
                <article id="post-<?php the_ID(); ?>" <?php post_class('af-single-article'); ?>>
                    ...
                    <div class="entry-content-wrap read-single <?php echo esc_attr($wrap_class); ?>">
                        ...
                        if (is_single()) {
                            ...
                            if ($single_post_title_view == 'boxed') {
                                do_action('reviewnews_action_single_header');
                            }
                        }
                        ?>
                        ...
                        if ($social_share_icon_opt == 'after-title-default') {
                            reviewnews_single_post_social_share_icons($post->ID);
                        } ?>

                        <?php
                        if (has_post_thumbnail($post->ID)) :
                            $show_featured_image = reviewnews_get_option('single_show_featured_image');
                            if ($show_featured_image) :

                        ?>
                                <div class="read-img pos-rel">
                                    <?php reviewnews_post_thumbnail(); ?>
                    ...
                    <?php
                    $show_related_posts = reviewnews_get_option('single_show_related_posts');
                    if ($show_related_posts) :
                        if ('post' === get_post_type()) :
                            reviewnews_get_block('related');
                        endif;
                    endif;
                    ?>
